...
public class CharSetUtilsQwen_POT2Test {
    ...
    public void testSqueeze_multipleRepetitions() {
        assertEquals("abcabc", CharSetUtils.squeeze("aabbccaaabbbccc", "a-c"));
    }

    @Test
    public void testSqueeze_repetitionsAtStart() {
        assertEquals("abccba", CharSetUtils.squeeze("aaabccba", "a-c"));
    }

    @Test
    public void testSqueeze_repetitionsAtEnd() {
        assertEquals("abccba", CharSetUtils.squeeze("abccbaaa", "a-c"));
    }
