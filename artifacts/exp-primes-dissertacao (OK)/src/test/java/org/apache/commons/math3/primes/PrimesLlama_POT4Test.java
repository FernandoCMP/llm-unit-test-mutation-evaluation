...
//    { "id": "P2", "description": "entrada no laço e retorno na primeira verificação (n é primo)" },
//    { "id": "P3", "description": "execução de ao menos uma iteração completa do laço (n não é primo)" }
//  ],
//  "planned_tests": [
...
public class PrimesLlama_POT4Test {
    ...
    @Test
    public void testNextPrime_FirstPrime() {
        assertEquals(3, Primes.nextPrime(3));
    }

    @Test
    public void testNextPrime_AfterLoop() {
        assertEquals(5, Primes.nextPrime(4));
    }

    @Test
    public void testNextPrime_NegativeNumber() {
        assertThrows(org.apache.commons.math3.exception.MathIllegalArgumentException.class, () -> Primes.nextPrime(-1));
    }
}
// ```
