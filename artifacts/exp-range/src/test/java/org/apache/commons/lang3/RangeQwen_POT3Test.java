...
public class RangeQwen_POT3Test {
    ...
    @Test
    public void testElementCompareTo_NullElement_ThrowsException() {
    ...
    @Test
    public void testElementCompareTo_ElementEqualsMin_ReturnsZero() {
        Range<Integer> range = Range.between(5, 10);
        assertEquals(0, range.elementCompareTo(5));
    }

    @Test
    public void testElementCompareTo_ElementEqualsMax_ReturnsZero() {
        Range<Integer> range = Range.between(5, 10);
