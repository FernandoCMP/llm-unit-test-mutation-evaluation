...
public class PrimesGrok_POT4Test {
    ...
    @Test
    void testNextPrime_ImmediatePrime() {
        int input = 5;
    ...
    @Test
    void testNextPrime_LoopSecondCheck() {
        int input = 143;
        int result = Primes.nextPrime(input);
        assertTrue(result >= input);
        assertTrue(Primes.isPrime(result));
    ...
    @Test
    void testNextPrime_LoopMultipleIterations() {
        int input = 215;
        int result = Primes.nextPrime(input);
        assertTrue(result >= input);
        assertTrue(Primes.isPrime(result));
