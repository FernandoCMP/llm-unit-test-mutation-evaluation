...
public class PrimesGrok_FS5Test {
  ...
  @Test
  void testNextPrime_WithFifteen() {
      assertEquals(17, Primes.nextPrime(15));
  }

  @Test
  void testNextPrime_WithTwenty() {
      assertEquals(23, Primes.nextPrime(20));
  }

  @Test
  void testNextPrime_WithNegativeOne() {
      assertThrows(MathIllegalArgumentException.class,
          () -> Primes.nextPrime(-1));
  }

  @Test
  void testNextPrime_WithNegativeFive() {
      assertThrows(MathIllegalArgumentException.class,
          () -> Primes.nextPrime(-5));
  }
}
