...
public class PrimesQwen_FS1Test {
    ...
    @Test
    void testNextPrime_evenNumberInput_returnsNextPrime() {
        assertEquals(31, Primes.nextPrime(28));
    }

    @Test
    void testNextPrime_maxInt_throwsExceptionOrReturnsCorrectly() {
        // Note: This may behave differently based on implementation details near Integer.MAX_VALUE
        // For now, we assume valid behavior as per method contract
