...
public class StringCompressionQwen_POT5Test {
    ...
    public void testCompress_alternatingCharacters() {
        assertEquals("a1b1c1d1", StringCompression.compress("abcd"));
    }

    @Test
    public void testCompress_mixedRepetitionEndingWithDifferentChar() {
