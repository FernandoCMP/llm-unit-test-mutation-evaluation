...
//     { "id": "U4", "variable": "input", "type": "p-use", "description": "comparação de caracteres adjacentes no else if (input.charAt(i) != input.charAt(i + 1))" },
//     { "id": "U5", "variable": "i", "type": "p-use", "description": "condição do laço (i < input.length() - 1)" },
//     { "id": "U6", "variable": "input", "type": "c-use", "description": "uso em input.length()" },
//     { "id": "U7", "variable": "input", "type": "c-use", "description": "uso em return input.charAt(0)" },
//     { "id": "U8", "variable": "input", "type": "c-use", "description": "uso em input.charAt(i)" },
//     { "id": "U9", "variable": "input", "type": "c-use", "description": "uso em input.charAt(i + 1)" },
//     { "id": "U10", "variable": "count", "type": "c-use", "description": "uso em incremento aritmético (count = count + 1)" },
//     { "id": "U11", "variable": "count", "type": "c-use", "description": "uso como argumento em appendCount" },
//     { "id": "U12", "variable": "compressedString", "type": "c-use", "description": "uso como argumento em appendCount" },
//     { "id": "U13", "variable": "compressedString", "type": "c-use", "description": "atribuição do retorno de appendCount" },
//     { "id": "U14", "variable": "compressedString", "type": "c-use", "description": "concatenação com caractere final" },
//     { "id": "U15", "variable": "compressedString", "type": "c-use", "description": "retorno do método" },
//     { "id": "U16", "variable": "i", "type": "c-use", "description": "uso em expressão aritmética (i + 1)" },
//     { "id": "U17", "variable": "i", "type": "c-use", "description": "incremento do laço (i++)" }
//   ],
//   "du_paths": [
...
public class StringCompressionGrok_POT1Test { }
